...
// ─── MAIN APP ─────────────────────────────────────────────────────────────────
// ─── PWA UPDATE BANNER ────────────────────────────────────────────────────────
// The installed app caches itself, so a new deploy would otherwise sit unused.
// This shows a small prompt instead of reloading under the user's feet — so no
// half-filled checklist is ever lost by a surprise refresh.
function UpdateBanner() {
  const {
    ...
    onRegisteredSW(swUrl, r) {
      if (!r) return;
      // Check for a newer version once an hour while the app stays open
  ...
  return (
    <div className="update-banner">
      <div className="update-banner-icon"><Icon.Refresh /></div>
      <div className="update-banner-text">
        <div className="update-banner-title">New version available</div>
        <div className="update-banner-sub">Reload to get the latest version of MyEdge.</div>
      </div>
